...
app.post('/productos_db', upload.single("foto"), (request, response) => {
    ...
    request.getConnection((error, conexion) => {
        ...
        conexion.query("INSERT INTO productos SET ?", [obj], (error, res) => {
            if (error) {
...
app.put('/productos_db', upload.single("foto"), (request, response) => {
    ...
    request.getConnection((error, conexion) => {
        ...
        conexion.query("UPDATE productos SET ? WHERE codigo = ?", [obj_modif, obj.codigo], (error, res) => {
            if (error) {
                throw ("Error en la consulta");
            }
...
app.delete('/productos_db', (request, response) => {
    ...
    request.getConnection((error, conexion) => {
        ...
        conexion.query("SELECT path FROM productos WHERE codigo = ?", [obj.codigo], (error, res) => {
            if (error) {
                throw ("Error en la consulta");
            }
    ...
    request.getConnection((error, conexion) => {
        ...
        conexion.query("DELETE FROM productos WHERE codigo = ?", [obj.codigo], (error, res) => {
            if (error) {
                throw ("Error en la consulta");
            }
