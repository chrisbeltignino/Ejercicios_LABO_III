...
function SubirFoto(){
        ...
        $("#fotoTmp").attr("src", "");//(<HTMLImageElement> document.getElementById("fotoTmp"));
        $("#lblFoto").html("");//<HTMLSpanElement> document.getElementById("lblFoto");
        
        AdministrarGif(true);

        let archivo : any = $("#archivo");//(<HTMLInputElement>document.getElementById("archivo"));
